			...
			<form:form method="POST" action="${destino}" commandName="junit"
				...
				<p>
					...
					<form:select path="accept" class="selectpicker form-control"
						...
						<form:option value="-">-</form:option>
						<form:option value="text/csv">CSV</form:option>
						<form:option value="application/rdf+xml">RDF/XML</form:option>
						<form:option value="text/turtle">Turtle</form:option>
						<form:option value="application/trix">TriX</form:option>
						<form:option value="application/trig">TriG</form:option>
						<form:option value="application/ld+json">JSON/LD</form:option>
						<form:option value="text/x-nquads">NQuads</form:option>
						<form:option value="text/plain">NTriples</form:option>
						<form:option value="text/rdf+n3">N3</form:option>
						<form:option value="application/rdf+json">RDF/JSON</form:option>
						<form:option value="application/x-binary-rdf">BinaryRDF</form:option>
						<form:option value="application/sparql-results+xml">SPARQLXMLResultsFormat</form:option>
						<form:option value="application/sparql-results+json">SPARQLJSONResultsFormat</form:option>
						<form:option value="text/boolean">SPARQLBooleanResults</form:option>
						<form:option value="application/x-binary-rdf-results-table">SPARQLBinaryResults</form:option>
						<form:option value="text/tab-separated-values">TABVAL</form:option>
						<form:option value="text/html">HTML</form:option>
					</form:select>
