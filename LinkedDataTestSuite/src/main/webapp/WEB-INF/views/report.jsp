...
<html>
  ...
  <header class="col-xs-12 text-center">
    ...
    GET:
    				...
    				[<a href=#3>GETResourceHTMLDocNoRedirect303</a>]
	...
	<table class="table table-hover">
   	...
   	<form action="run" method="post">
   		<tr>
	   		...
	   		<td id=3>GETResourceHTMLDocNoRedirect303</td>
	   		...
	   		<td style="text-align: center;"><a style="color:black;" href="/static/GETNO303text_htmlid_medio-ambiente_calidad-del-aire_elemento_CO-2017-01-02GETResourceHTMLDocNoRedirect303"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></a></td>
    	</tr>
